...
export function buildInternalOwnerTenantAppScreen(options = {}) {
  ...
  return {
    ...
    bootstrapNotice: "Bootstrap profile protected by the existing operator token. Owner authorization and single-tenant request scoping are enforced for the fixed internal tenant. Multi-tenant data partitioning is not implemented yet.",
    routes: {
      appHomeHref: "/app",
