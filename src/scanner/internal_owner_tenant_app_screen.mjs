...
export function buildInternalOwnerTenantAppScreen(options = {}) {
  ...
  return {
    ...
    bootstrapNotice: "Bootstrap profile protected by the existing operator token. Owner authorization is enforced for the fixed internal tenant and owner role. Multi-tenant isolation is not implemented yet.",
    routes: {
      appHomeHref: "/app",
