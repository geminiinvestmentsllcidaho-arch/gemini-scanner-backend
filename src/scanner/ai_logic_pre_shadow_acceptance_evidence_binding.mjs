...
export function evaluateAiLogicPreShadowAcceptanceEvidenceBinding(input={}){
 ...
 if(present(orchestrator.candidateTopic)&&orchestratorSafety.topic!==orchestrator.candidateTopic)reasons.push("ORCHESTRATOR_CANDIDATE_TOPIC_BINDING_MISMATCH");
 if(present(orchestrator.candidateTopic)&&safetyGate.topic!==orchestrator.candidateTopic)reasons.push("SAFETY_GATE_CANDIDATE_TOPIC_BINDING_MISMATCH");
