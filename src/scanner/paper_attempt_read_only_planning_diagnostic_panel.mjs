...
export function buildPaperAttemptReadOnlyPlanningDiagnosticPanel() {
  const planningChecklist = [
    { id: "operator_review_packet_present", label: "Operator review packet present", status: "review_required", readOnly: true },
    { id: "summary_panel_reviewed", label: "Read-only operator summary panel reviewed", status: "review_required", readOnly: true },
    { id: "candidate_inputs_verified", label: "Candidate symbol, action, entry, exit, and risk inputs verified", status: "blocked_until_operator_review", readOnly: true },
    { id: "broker_execution_disabled", label: "Broker execution path disabled", status: "locked", readOnly: true }
  ];
