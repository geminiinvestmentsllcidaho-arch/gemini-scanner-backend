...
const DEFAULT_ENTRIES = Object.freeze([
  ...
  Object.freeze({
    ...
    href: "/diagnostics/market-closed-scanner-snapshot-panel",
    diagnosticHref: "/diagnostics/market-closed-scanner-snapshot",
    routeHref: "/diagnostics/market-closed-scanner-snapshot-panel",
    displayState: "MARKET_CLOSED_SCANNER_SNAPSHOT_PANEL_READONLY",
    refreshFriendly: true,
  }),
  Object.freeze({
    id: "snapshot_history",
    ...
    description: "Read-only history reader for local market-closed snapshot records.",
    category: "scanner_snapshots",
    href: "/diagnostics/market-closed-scanner-snapshot-store/history",
    diagnosticHref: "/diagnostics/market-closed-scanner-snapshot-store/history",
    routeHref: "/diagnostics/market-closed-scanner-snapshot-store-panel",
  ...
  Object.freeze({
    ...
    category: "scanner_snapshots",
    href: "/diagnostics/market-closed-scanner-snapshot-store-panel",
    diagnosticHref: "/diagnostics/market-closed-scanner-snapshot-store-panel",
