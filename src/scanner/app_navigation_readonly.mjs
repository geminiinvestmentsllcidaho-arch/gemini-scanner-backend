...
const DEFAULT_ENTRIES = Object.freeze([
  ...
  Object.freeze({
    ...
    routeHref: "/diagnostics/retention-cleanup-app-screen",
  ...
  Object.freeze({
    ...
    routeHref: "/diagnostics/paper-readiness-gate-app-screen",
  ...
  Object.freeze({
    ...
    routeHref: "/diagnostics/paper-trade-intent-plan-app-screen",
  ...
  Object.freeze({
    ...
    routeHref: "/diagnostics/paper-attempt-control-center-app-screen",
  ...
  Object.freeze({
    ...
    routeHref: "/diagnostics/paper-attempt-operator-review-packet-app-screen",
  ...
  Object.freeze({
    ...
    routeHref: "/diagnostics/paper-attempt-operator-review-packet-audit-dashboard-app-screen",
  ...
  Object.freeze({
    ...
    routeHref: "/diagnostics/paper-attempt-module-complete-selector-app-screen",
  ...
  Object.freeze({
    ...
    routeHref: "/diagnostics/paper-attempt-read-only-operator-summary-app-screen",
