...
export function buildDecisionQualityClassificationReport(evaluationReport = {}, options = {}) {
  ...
  const items = sourceEvaluations.map((row) => {
    ...
    return Object.freeze({
      ...
      originMarketOpen: row?.originMarketOpen === true,
  ...
  return Object.freeze({
    ...
    marketOpenObservationsOnly: evaluationReport?.marketOpenObservationsOnly === true,
    freshSourceObservationsOnly: evaluationReport?.freshSourceObservationsOnly === true,
