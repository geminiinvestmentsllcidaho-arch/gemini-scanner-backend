...
export function buildAiLogicPromotionDecisionEvidenceRecord(decision = {}, options = {}) {
  ...
  const required = ["acceptanceRecordId","candidateId","knownGoodRecordId","replayId","sourceCommitBefore","sourceCommitAfter","candidateSourceHash","candidatePath","candidateTopic"];
