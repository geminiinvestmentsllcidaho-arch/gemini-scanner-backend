...
export function buildDecisionQualityProposalReport(classificationReport = {}, options = {}) {
  ...
  const proposals = sourceQueue
    .map((item, index) => {
      ...
      return Object.freeze({
        ...
        sourceMarketOpen: item?.originMarketOpen === true,
        sourceStale: item?.originSourceStale === true,
        sourceObservable: item?.originObservable === true,
  ...
  return Object.freeze({
    ...
    marketOpenObservationsOnly: classificationReport?.marketOpenObservationsOnly === true,
    freshSourceObservationsOnly: classificationReport?.freshSourceObservationsOnly === true,
