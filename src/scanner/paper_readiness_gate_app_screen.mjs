...
export function buildPaperReadinessGateAppScreen(options = {}) {
  ...
  return {
    ...
    displayState: ready ? "PAPER_READINESS_GATE_APP_SCREEN_READY_READONLY" : "PAPER_READINESS_GATE_APP_SCREEN_BLOCKED_READONLY",
    ...
    summaryCards: [{ label: "Ready", value: ready ? "yes" : "no" }, { label: "Checks", value: String(checks.length) }, { label: "Blockers", value: String(blockerCount) }],
    generatedAt: now,
    lastUpdatedAt: now,
    ...
    paperOnly: true,
    readOnly: true, monitorOnly: true, diagnosticsOnly: true, noExecutionControls: true,
